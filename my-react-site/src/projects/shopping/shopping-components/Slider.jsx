...
const Slider = ({list}) => {
    ...
    return (
      ...
      <h2 
                  className='text-center text-black text-3xl mt-10 mb-10 tracking-wide font-extrabold' 
                >NEW ARRIVALS
                </h2>
        <div
            ref={myRef}
        ...
        > 
            { list.map( (item, index) => {
              return ( <Link to={`/projects/shop/home/${item.id}`}><ClothArticle item={item} key={index} /> </Link>)
            }) }
